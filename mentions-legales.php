...
<?php body_class(); ?>>
    ...
    <div class="container mt-5 mb-5">
        ...
        <section class="mt-4">
            ...
            <p>Cook'It Yourself met tout en œuvre pour assurer l'exactitude et la mise à jour des informations diffusées sur ce site. Cependant, la société ne peut garantir que les informations fournies soient exemptes d'erreurs ou d'omissions.</p>
            <p>En cas de question ou de problème, n'hésitez pas à nous contacter via l'adresse e-mail mentionnée ci-dessus.</p>
        </section>
